...
namespace Eblue.essentials
{
    public delegate void backHandler<type>(dynamic sender, methodEventArgs e);
    public delegate void execHandler<type>(dynamic sender, methodEventArgs e, backHandler<execHandler<type>> callBack = null);
    public delegate dynamic evalHandler<type>(dynamic sender, methodEventArgs e, backHandler<execHandler<type>> callBack = null);
    ...
    public class TzLogger: Tlogger
    {

    }

    public class TyLogger : Tlogger
    {

    }

    public class TxLogger : Tlogger
    {

    }

    public class TwLogger : Tlogger
    {

    }

    public class TdivForm : Panel
    {
        ...
        public TdivForm()
        {
            ...
            myPanelStyle.BackImageUrl = @"~\dist\img\photo1.png";

            // Use the ApplyStyle method of the Panel control to apply
            // the settings from the myPanelStyle object.
            this.ApplyStyle(myPanelStyle);
    ...
    public class Twebform : Page
    {
        ...
        //at success  user
        #endregion
        #region about navigation
        //at restrict user
        //at deny  user
        //at grant  user
        #endregion
        #region about ?
        //at restrict player.rosterType
        //at deny  player.rosterType
        //at grant  player.rosterType
        #endregion

        #region about ?
        //at restrict player.roleType
        //at deny  player.roleType
        //at grant  player.roleType
        #endregion
        #endregion
    ...
    /// <summary>
    /// used for default.login, redirect.signout
    /// </summary>
    public class TpageBasic : Twebform
    { 
    
    
    }

    public class TpageGeneral : TpageBasic
    {
        #region body
    ...
    public class dome {
        ...
        public void init()
        {
            ...
            #region none
            //default, signout
            WebForm1 defaultPage = null;
            #endregion

            #region none
            //home, whichIpartipate
            #endregion
