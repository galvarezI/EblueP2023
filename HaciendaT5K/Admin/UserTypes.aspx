<%@ Page Title="Estación Experimental Agrícola - User Types" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="UserTypes.aspx.cs" Inherits="Eblue.Admin.UserTypes" %>
        ...
        <div class="content-wrapper" style="min-height: 568px;">
                      ...
                      <option>option 5</option>
                                    ...
                                    <asp:SqlDataSource
                                        ...
                                        SelectCommand="
                                          ...
                                          concat ( rsp.Name, ' (', rsp.Description, ')') FullDescription from 
                                          RosterSetPermission rsp
                                          where 
            ...
            the plugin.
                    ...
                    <div class="row">
                                    ...
                                    <asp:GridView ID="gvModel" runat="server" CssClass="gridview table table-bordered table-striped" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Which are it?">
                                                ...
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblWhichAreItItem" runat="server" Text='<%# Bind("UserIndex") %>'></asp:Label>--%>
                                        ...
                                        <asp:ListItem Value="">None</asp:ListItem>
                                            ...
                                            <asp:CommandField   ButtonType="Button" HeaderText ="Actions" ShowEditButton="true" ShowDeleteButton="true"  />
                                        </Columns>
                        ...
                        UpdateCommand="update Rostercategory set orderpriority = 0 where orderline = 0"
                        SelectCommand="
                                        
                                        select 
iif (rsp.PSetID is null, cast(0 as bit), cast(1 as bit) ) hasUserPermissionSet, rsp.PSetID, rsp.PSetDescription ,
iif (rp.UserCategoryID is null, cast(0 as bit), cast(1 as bit) ) hasUserPermission,

ROW_NUMBER() over (order by orderpriority ) as rowNumber, 0 as whichAreIt , uid, name, description, orderpriority as priority,
                                        isSupervisor  IsDirectiveLeader, 
                                        isAdmin IsAssistantLeader, 
                                        isManager IsDirectiveManager, 
                                        IsScientist IsVisorCompany, 
                                        isPersonnel IsWorkAdministrator, 
                                        isStudent IsWorkMember, 
                                        isplanViewer IsTaskOfficer,
                                        isCoordinator IsInvestigationOfficer,
                                        cast(0 as bit) HasSignature, cast(0 as bit) HasRejection, cast(0 as bit) HasAproval, cast(0 as bit) HasComment 
                                        
                                        from RosterCategory 
										left join
										(
										select RosterCategoryID UserCategoryID, RosterSetPermissionID UserSetPermissionID from RosterPermission
										) as rp on rp.UserCategoryID = UId
										left join 
										(
										select 
  UId PSetID, Description PSetDescription from RosterSetPermission 
  where 
  IsRoot = 1 and IsForProject = 1
										) as rsp on rsp.PSetID = rp.UserSetPermissionID
										order by RowNumber
                        ...
                        ConnectionString="<%$ ConnectionStrings:eblueConnectionString %>"
                                        OldValuesParameterFormatString="original_{0}"
                        UpdateCommand="update Usercategory set orderpriority = 0 where orderline = 0"
                        SelectCommand="
...
ROW_NUMBER() over (order by orderpriority ) as rowNumber, 0 as whichAreIt , uid, name, description, orderpriority as priority,
                                        ...
                                        ELSE 'undefined' END AS Userindex,
										...
										left join
										(
										select UserCategoryID, UserSetPermissionID from UserPermission
										) as rp on rp.UserCategoryID = UId
										left join 
										(
										select 
  UId PSetID, concat ( Name, ' (',Description, ')') PSetDescription from UserSetPermission 
  where 
  IsRoot = 1 and IsForProject = 1
										) as rsp on rsp.PSetID = rp.UserSetPermissionID
										order by RowNumber
                                    ...
                                    <%--<div id="example1_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="example1" class="table table-bordered table-striped dataTable" User="grid" aria-describedby="example1_info">
                                                    <thead>
                                                        <tr User="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-5">
                                                <div class="dataTables_info" id="example1_info" User="status" aria-live="polite">Showing 1 to 10 of 57 entries</div>
                                            </div>
