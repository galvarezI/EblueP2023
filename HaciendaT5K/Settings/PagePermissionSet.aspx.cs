...
namespace Eblue.Settings
{
    ...
    public partial class PagePermissionSet : Eblue.Code.PageBasic
    {
        ...
        protected bool AddModelToDB(string name, string description, Guid? parentId, Tuple<bool, bool, bool> usedFor, Tuple<bool, bool, bool> forData, Tuple<bool, bool, bool, bool, bool> forList, Guid sectionID)
        {
            ...
            try
            {
                ...
                string insertCommand =
                    $"insert into RosterSetPermission (uid, name, description, targetof, " +
                    $"isroot, isforproject, isforprocess, " +
                    $"whenGet, GetCapOpen, GetCapBlocked, " +
                    $"whenPost, PostCapClose, PostCapBlocked, PostCapUp, PostCapDown, userTargetID, withTargetOf) " +
            ...
            {
                throw new Exception("Error while trying to add target page permission set", ex);
            }
            finally
            {
        ...
        protected bool UpdateModelToDB(Guid uid, string name, string description, Guid? parentId, Tuple<bool, bool, bool> usedFor, Tuple<bool, bool, bool> forData, Tuple<bool, bool, bool, bool, bool> forList, Guid sectionID)
        {
            ...
            try
            {
                ...
                string updateCommand =
                    ...
                    $"whenGet = @whenData,GetCapOpen = @dataCapDetail, GetCapBlocked = @dataCapEdit," +
                    $"whenPost = @whenList, PostCapClose = @listCapDetail, PostCapBlocked = @listCapAdd, PostCapUp = @listCapRemove,PostCapDown = @listCapEdit, usertargetid = @sectionId, " +
            ...
            {
                throw new Exception("Error while trying to update target page permission set", ex);
            }
            finally
            {
