<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master.Master" AutoEventWireup="true" CodeBehind="DeptProject.aspx.cs" Inherits="Eblue.Reports.DeptProject" %>
    ...
    <div class="container">
        <div class="form-row">
            ...
            <div class="col-md-12">
                ...
                <asp:SqlDataSource ID="admindept" runat="server" ConnectionString="<%$ ConnectionStrings:eblueConnectionString %>" SelectCommand="SELECT * FROM [Departments]"></asp:SqlDataSource>
            </div>
            <br />
            <br />
            <div class="row">
