      ...
      for (j in colAttrs) {
        ...
        if (parseInt(j) === 0 && rowAttrs.length !== 0) {
          ...
          th.setAttribute("colspan", rowAttrs.length);
            ...
            var pivotcaption = document.getElementById("pivotcaption");
            if (pivotcaption) {
                th.textContent = $(pivotcaption).val();
            }
            else {
                th.textContent = "Pivot Report Generator";
            }
      ...
      try {
        ...
        if (opts.unusedAttrsVertical === true || unusedAttrsVerticalAutoOverride) {
          ...
          uiTable.find('tr:nth-child(2)').prepend(unused);
            ...
            uiTable[0].setAttribute("style", "width:100%; height:100%");
            //var firstCol = uiTable[0].cols[0];

        }
          this.html(uiTable);
          var uiRows = document.querySelectorAll(".pvtUi tr");
          $(uiRows).each(function () {
              var uiCols = $(this).find("td");
              $(uiCols[0]).attr("style","width:20%;");
          });
